...
export default function AdminNavigation() {
    ...
    return (
        <div className="shadow-blue-gray-900/5 relative flex h-[calc(100vh-2rem)] w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl mr-16">
            ...
            <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-gray-700">
                ...
                >
                   ...
                   {/*  <Link href="admin/users" className="mr-4 flex items-center gap-5">
                    <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                ...
                >
                    ...
                    Manage categories<div className="ml-auto grid place-items-center justify-self-end"></div>
                </div>
                <div
                    role="button"
                    className="flex w-full items-center rounded-lg p-3 text-start leading-tight outline-none transition-all hover:bg-blue-50 hover:bg-opacity-80 hover:text-blue-900 focus:bg-blue-50 focus:bg-opacity-80 focus:text-blue-900 active:bg-blue-50 active:bg-opacity-80 active:text-blue-900"
